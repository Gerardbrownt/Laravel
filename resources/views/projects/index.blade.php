    ...
    <div class="col-9">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr class="project-row" onmouseover="this.classList.add('hover');" onmouseout="this.classList.remove('hover');">
            <th scope="row">{{ $proyecto->id }}</th>
            <td>{{ $proyecto->titulo }}</td>
            <td>{{ $proyecto->descripcion }}</td>
            <td>
              {{ $proyecto->created_at }}
              <button type="button" class="btn btn-danger btn-sm float-end delete-btn d-none"
      ...
      <form id="deleteForm" method="POST">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ¿Estás seguro de que quieres eliminar el proyecto <strong id="projectTitle"></strong>?
          </div>
